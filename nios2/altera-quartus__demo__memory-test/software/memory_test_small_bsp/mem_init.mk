...
$(MEM_1)_START := 0x0c060000
$(MEM_1)_END := 0x0c07ffff
$(MEM_1)_SPAN := 0x00020000
$(MEM_1)_HIERARCHICAL_PATH := ram0
$(MEM_1)_WIDTH := 32
...
.PHONY: ram0
ram0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: ram1
MEM_2 := nios2_de1soc_ram1
$(MEM_2)_NAME := ram1
...
$(MEM_2)_START := 0x0c040000
$(MEM_2)_END := 0x0c05ffff
$(MEM_2)_SPAN := 0x00020000
$(MEM_2)_HIERARCHICAL_PATH := ram1
$(MEM_2)_WIDTH := 32
...
.PHONY: ram1
ram1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
