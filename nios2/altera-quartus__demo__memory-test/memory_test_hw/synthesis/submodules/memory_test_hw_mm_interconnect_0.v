...
module memory_test_hw_mm_interconnect_0 (
		...
		output wire [14:0] ram1_s1_address,                         //                           ram1_s1.address
	...
	wire   [27:0] ram0_s1_agent_m0_address;                                                    // ram0_s1_agent:m0_address -> ram0_s1_translator:uav_address
	...
	wire  [104:0] ram0_s1_agent_rf_source_data;                                                // ram0_s1_agent:rf_source_data -> ram0_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] ram0_s1_agent_rsp_fifo_out_data;                                             // ram0_s1_agent_rsp_fifo:out_data -> ram0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> ram0_s1_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> ram0_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                       // ram0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> ram0_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> ram0_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> ram0_s1_agent:cp_endofpacket
	...
	wire   [27:0] ram1_s1_agent_m0_address;                                                    // ram1_s1_agent:m0_address -> ram1_s1_translator:uav_address
	...
	wire  [104:0] ram1_s1_agent_rf_source_data;                                                // ram1_s1_agent:rf_source_data -> ram1_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] ram1_s1_agent_rsp_fifo_out_data;                                             // ram1_s1_agent_rsp_fifo:out_data -> ram1_s1_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> ram1_s1_agent:cp_valid
	wire  [103:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> ram1_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // ram1_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> ram1_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> ram1_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> ram1_s1_agent:cp_endofpacket
	...
	wire          ram0_s1_agent_rp_valid;                                                      // ram0_s1_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] ram0_s1_agent_rp_data;                                                       // ram0_s1_agent:rp_data -> router_004:sink_data
	wire          ram0_s1_agent_rp_ready;                                                      // router_004:sink_ready -> ram0_s1_agent:rp_ready
	wire          ram0_s1_agent_rp_startofpacket;                                              // ram0_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          ram0_s1_agent_rp_endofpacket;                                                // ram0_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          ram1_s1_agent_rp_valid;                                                      // ram1_s1_agent:rp_valid -> router_005:sink_valid
	wire  [103:0] ram1_s1_agent_rp_data;                                                       // ram1_s1_agent:rp_data -> router_005:sink_data
	wire          ram1_s1_agent_rp_ready;                                                      // router_005:sink_ready -> ram1_s1_agent:rp_ready
	wire          ram1_s1_agent_rp_startofpacket;                                              // ram1_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          ram1_s1_agent_rp_endofpacket;                                                // ram1_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          ram0_s1_agent_rdata_fifo_src_valid;                                          // ram0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] ram0_s1_agent_rdata_fifo_src_data;                                           // ram0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          ram0_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_002:in_0_ready -> ram0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> ram0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> ram0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                           // ram0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> ram0_s1_agent:rdata_fifo_sink_error
	wire          ram1_s1_agent_rdata_fifo_src_valid;                                          // ram1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] ram1_s1_agent_rdata_fifo_src_data;                                           // ram1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          ram1_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_003:in_0_ready -> ram1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> ram1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> ram1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                           // ram1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> ram1_s1_agent:rdata_fifo_sink_error
	...
	memory_test_hw_mm_interconnect_0_router_003 router_003 (
	...
	memory_test_hw_mm_interconnect_0_router_002 router_004 (
	...
	memory_test_hw_mm_interconnect_0_router_002 router_006 (
	...
	memory_test_hw_mm_interconnect_0_router_007 router_007 (
	...
	memory_test_hw_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_cmd_demux_001 rsp_demux_005 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	memory_test_hw_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
