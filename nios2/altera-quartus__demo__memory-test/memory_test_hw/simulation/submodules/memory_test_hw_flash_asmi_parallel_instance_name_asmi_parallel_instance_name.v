...
//synthesis_resources = a_graycounter 6 cyclonev_asmiblock 1 lpm_compare 3 lpm_counter 3 lut 29 mux21 19 reg 202 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  memory_test_hw_flash_asmi_parallel_instance_name_asmi_parallel_instance_name
	( 
	addr,
	bulk_erase,
	busy,
...
`endif
	...
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) write_prot_reg <= 1'b0;
			...
			else  write_prot_reg <= ((((do_write | do_sec_erase) & (~ prot_wire[0])) & (((~ mask_prot_comp_ntb[4]) & (~ tb_wire)) | ((~ mask_prot_comp_tb[4]) & tb_wire))) | be_write_prot);
	assign
...
endmodule //memory_test_hw_flash_asmi_parallel_instance_name_asmi_parallel_instance_name
//VALID FILE
