...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "memory_test_hw"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_ram1.hex ./
  file copy -force $QSYS_SIMDIR/submodules/memory_test_hw_ram0.hex ./
}
...
ensure_lib                                            ./libraries/ram1                                      
vmap       ram1                                       ./libraries/ram1                                      
ensure_lib                                            ./libraries/ram0                                      
vmap       ram0                                       ./libraries/ram0                                      
...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_avalon_st_adapter_005_error_adapter_0.sv" -work error_adapter_0                           
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"     -work error_adapter_0                           
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_avalon_st_adapter_005.v"                  -work avalon_st_adapter_005                     
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_avalon_st_adapter.v"                      -work avalon_st_adapter                         
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_rsp_mux_001.sv"                           -work rsp_mux_001                               
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_rsp_mux.sv"                               -work rsp_mux                                   
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_rsp_demux.sv"                             -work rsp_demux                                 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_cmd_mux_001.sv"                           -work cmd_mux_001                               
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_cmd_mux.sv"                               -work cmd_mux                                   
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_cmd_demux_001.sv"                         -work cmd_demux_001                             
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_cmd_demux.sv"                             -work cmd_demux                                 
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_router_007.sv"                            -work router_007                                
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_router_003.sv"                            -work router_003                                
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_router_002.sv"                            -work router_002                                
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_router_001.sv"                            -work router_001                                
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0_router.sv"                                -work router                                    
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_test_bench.v"                                     -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu.v"                                                -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_debug_slave_wrapper.v"                            -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_debug_slave_sysclk.v"                             -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_nios2_cpu_debug_slave_tck.v"                                -work cpu                                       
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/memory_test_hw_irq_mapper.sv"                                              -work irq_mapper                                
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_mm_interconnect_0.v"                                        -work mm_interconnect_0                         
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_sdram.v"                                                    -work sdram                                     
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_ram1.v"                                                     -work ram1                                      
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_ram0.v"                                                     -work ram0                                      
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_pll.vo"                                                     -work pll                                       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_nios2.v"                                                    -work nios2                                     
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_led.v"                                                      -work led                                       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/memory_test_hw_jtag_uart.v"                                                -work jtag_uart                                 
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/memory_test_hw.v"                                                                                                                     
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L error_adapter_0 -L avalon_st_adapter_005 -L avalon_st_adapter -L sdram_s1_rsp_width_adapter -L rsp_mux_001 -L rsp_mux -L rsp_demux -L cmd_mux_001 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L sdram_s1_burst_adapter -L router_007 -L router_003 -L router_002 -L router_001 -L router -L jtag_uart_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_avalon_jtag_slave_agent -L nios2_data_master_agent -L jtag_uart_avalon_jtag_slave_translator -L nios2_data_master_translator -L cpu -L rst_controller -L irq_mapper -L mm_interconnect_0 -L sdram -L ram1 -L ram0 -L pll -L nios2 -L led -L jtag_uart -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
