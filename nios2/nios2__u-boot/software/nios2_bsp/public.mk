...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2_de1soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_de1soc
SOPC_NAME := nios2_de1soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8081060
SOPC_SYSID_FLAG += --sidp=0x8081060
ELF_PATCH_FLAG  += --sidp 0x8081060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1604830868
SOPC_SYSID_FLAG += --timestamp=1604830868
ELF_PATCH_FLAG  += --timestamp 1604830868
