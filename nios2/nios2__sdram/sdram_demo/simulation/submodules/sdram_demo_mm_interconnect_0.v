// sdram_demo_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module sdram_demo_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> led_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> sw_s1_agent:cp_data
	...
	wire  [105:0] ram_s1_agent_rf_source_data;                                                 // ram_s1_agent:rf_source_data -> ram_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] ram_s1_agent_rsp_fifo_out_data;                                              // ram_s1_agent_rsp_fifo:out_data -> ram_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> ram_s1_agent:cp_data
	...
	wire  [104:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] led_s1_agent_rp_data;                                                        // led_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] sw_s1_agent_rp_data;                                                         // sw_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] ram_s1_agent_rp_data;                                                        // ram_s1_agent:rp_data -> router_006:sink_data
	...
	sdram_demo_mm_interconnect_0_router router (
	...
	sdram_demo_mm_interconnect_0_router_001 router_001 (
	...
	sdram_demo_mm_interconnect_0_router_002 router_002 (
	...
	sdram_demo_mm_interconnect_0_router_003 router_003 (
	...
	sdram_demo_mm_interconnect_0_router_002 router_004 (
	...
	sdram_demo_mm_interconnect_0_router_002 router_005 (
	...
	sdram_demo_mm_interconnect_0_router_003 router_006 (
	...
	sdram_demo_mm_interconnect_0_router_007 router_007 (
	...
	sdram_demo_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clocks_sys_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clocks_sys_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clocks_sys_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_demo_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	sdram_demo_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
