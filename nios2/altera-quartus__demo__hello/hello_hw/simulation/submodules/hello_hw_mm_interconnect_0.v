...
`timescale 1 ps / 1 ps
module hello_hw_mm_interconnect_0 (
	...
	hello_hw_mm_interconnect_0_router router (
	...
	hello_hw_mm_interconnect_0_router_001 router_001 (
	...
	hello_hw_mm_interconnect_0_router_002 router_002 (
	...
	hello_hw_mm_interconnect_0_router_003 router_003 (
	...
	hello_hw_mm_interconnect_0_router_003 router_004 (
	...
	hello_hw_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_hw_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
