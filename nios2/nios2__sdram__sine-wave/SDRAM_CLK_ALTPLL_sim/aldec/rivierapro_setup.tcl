...
# ACDS 18.1 646 linux 2020.08.26.18:19:26
# ----------------------------------------
...
# ----------------------------------------
# If SDRAM_CLK_ALTPLL is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "SDRAM_CLK_ALTPLL"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SDRAM_CLK_ALTPLL.vho"
}
